							...
							<table id="table_macros_field" class="table table-hover table-striped table-macros-field">
								...
								<?php foreach ($manufacturer_macros as $fields) { ?>
									<tr id="macros-field-row<?php echo $field_row; ?>">
										...
										<td class="text-left"><input type="hidden" name="manufacturer_macros[<?php echo $field_row; ?>][field_type]" value="<?php echo isset($fields['field_type']) ? $fields['field_type']: 'HTML'; ?>"/><?php echo isset($fields['field_type']) ? $fields['field_type']: 'HTML'; ?></td>
...
<script type="text/javascript">
	...
	function addMacrosRow() {
		...
		var field_name = $('#table_macros_field #tbl_field_name option:selected').val();
		var csv_name = $('#table_macros_field #csv_name').val();
		var csv_caption = $('#table_macros_field #csv_caption').val();
		var field_type = $('#table_macros_field #field_type').val();
		...
		html += '    <td class="text-left"><input type="hidden" name="manufacturer_macros[' + field_row + '][field_type]" value="' + field_type + '" size="1" />' + field_type + '</td>';
