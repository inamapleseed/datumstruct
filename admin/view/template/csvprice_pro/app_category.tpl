				...
				<div class="tab-content">
					...
					<div id="tab_macros" class="tab-pane fade">
							...
							<form action="<?php echo $action; ?>" method="post" id="form_macros" enctype="multipart/form-data" class="form-horizontal">
								...
								<table id="table-custom-fields" class="table table-hover table-striped table-macros-field">
									<thead>
										<tr>
									...
									<?php foreach ($category_macros as $fields) { ?>
										<tr id="custom-fields-row<?php echo $field_row; ?>">
											...
											<td class="text-left"><input type="hidden" name="category_macros[<?php echo $field_row; ?>][field_type]" value="<?php echo isset($fields['field_type']) ? $fields['field_type']: 'HTML'; ?>"/><?php echo isset($fields['field_type']) ? $fields['field_type']: 'HTML'; ?></td>
									...
									<tbody id="tbody_form" class="csvpricepro_tbody-form">
										<tr>
											<td>
											<select id="tbl_name" onchange="loadFields();" class="form-control input-sm">
											...
											<td>
												<select id="custom_fields" onchange="selectFieldName();" class="form-control input-sm"></select>
											</td>
											<td>
								...
								<?php if(isset($help_macro_field_type)) { ?><p class="help-block"><?php echo $help_macro_field_type; ?></p><?php } ?>
							</form>
						<div class="row">
							<div class="col-sm-12">
								<hr />
...
<script type="text/javascript">
	...
	$('.csvprice_pro_container #category_list').delegate('.fa-minus-circle', 'click', function () {
		...
		function addFieldRow() {
			...
			html += '    <td class="text-left"><input type="hidden" name="category_macros[' + field_row + '][field_type]" value="' + field_type + '" size="1" />' + field_type + '</td>';
