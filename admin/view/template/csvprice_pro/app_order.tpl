							...
							<div class="row">
								...
								<div class="col-sm-6">
									<table class="table table-hover csvpricepro-field_set">
										<tbody>
								<?php } ?>
										<?php if (isset($fields_set_help[$key])) { ?>
										<tr id="row_<?php echo $id; ?>">
											...
											<td><input class="form-control input-sm" type="text" name="csv_setting[fields_set][<?php echo $key; ?>][caption]" value="<?php echo $csv_setting['fields_set'][$key]['caption']; ?>"></td>
										</tr>
										<?php } ?>
								<?php $id++; ?>
								<?php } ?>
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<div class="input-group datetime">
												...
												<span class="input-group-btn"> <button class="btn btn-default btn-sm" type="button"><i class="fa fa-calendar"></i></button> <button class="btn btn-default btn-sm btn-calendar-check-o" type="button" data-toggle="tooltip" title="<?php echo $text_cur_date; ?>"><i class="fa fa-refresh"></i></button> <button class="btn btn-default btn-sm btn-calendar-eraser" type="button" data-toggle="tooltip" title="<?php echo $text_clear; ?>"><i class="fa fa-eraser"></i></button> </span>
											</div>
