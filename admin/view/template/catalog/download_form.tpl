    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-description"><span data-toggle="tooltip" title="<?php echo $help_description; ?>">Description</span></label>
            <div class="col-sm-10">
                <input type="text" name="description" value="<?= $description; ?>"  id="input-description" class="form-control" />
            </div>
          </div>
          <div class="form-group">
              <label class="col-sm-2 control-label" for="input-file-image">File Image</label>
              <div class="col-sm-10"><a href="" id="thumb-file-image" data-toggle="image" class="img-thumbnail"><img src="<?= $file_image; ?>" alt="" title="" data-placeholder="<?= $placeholder; ?>" /></a>
                  <input type="hidden" name="file_file_image" value="<?= $file_file_image; ?>" id="input-file-image" />
              </div>
            </div>
          <div class="form-group required">
