								...
								<?php foreach ($languages as $language) { ?>
									<div class="tab-pane" id="language<?= $language['language_id']; ?>">
										<div class="form-group hidden">
											<div class="col-sm-10">
												<input type="checkbox" name="upc" value="<?=$upc;?>">
											</div>
										</div>
						...
						<div class="tab-pane" id="tab-links">
								...
								<div class="form-group required">
									...
									<div class="col-sm-10">
										<div class="radio">
											<label>
												<input type="radio" name="products_category" value="enquiry" <?php if($products_category == 'enquiry'){?>checked="checked"<?php } ?> />
												Enquiry
											</label>
										</div>
										<div class="radio">
											<label>
												<input type="radio" name="products_category" value="shop_product" <?php if($products_category == 'shop_product'){?>checked="checked"<?php } ?> />
												Shop
											</label>
										</div>
