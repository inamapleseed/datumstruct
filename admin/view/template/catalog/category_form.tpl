				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-menu" class="form-horizontal">
					...
					<div class="tab-content">
						...
						<div class="tab-pane " id="tab-data">
							...
							<!-- Start products or gallery -->
								<div class="form-group required">
									...
									<div class="col-sm-10">
										<div class="radio">
											<label>
												<input type="radio" name="category_names" value="enquiry" <?php if($category_names == 'enquiry'){?>checked="checked"<?php } ?> />
												Enquiry
											</label>
										</div>
										<div class="radio">
											<label>
												<input type="radio" name="category_names" value="shop_product" <?php if($category_names == 'shop_product'){?>checked="checked"<?php } ?> />
												Shop
											</label>
										</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-status">Tag to Menu</label>
								<div class="col-sm-10">
									<select name="is_menu" id="input-status" class="form-control">
										<?php if ($is_menu == 1) { ?>
											<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
											<option value="0"><?php echo $text_disabled; ?></option>
											<?php } else { ?>
