...
$_['text_menu_log'] = 'Журнал';
$_['text_menu_about'] = 'Про модуль';
$_['mod_demo'] = '0';
$_['mdemo_title'] = '
<div class="well"><p><a target="blank" href="http://store.opencartlabs.ru/obmen-dannymi/csv-price-pro-importexport-4-trial-key.html"><strong>Получить триальную лицензию на 7 дней для ознакомления с функционалом дополнения (модуля)</strong></a><br />
