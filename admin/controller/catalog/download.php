...
//here		
		...
		if (isset($this->request->post['file_file_image'])) {
			$data['file_file_image'] = $this->request->post['file_file_image'];
		} else {
			$data['file_file_image'] = $download_info['image'];
		}

		if (isset($this->request->post['file_file_image']) && is_file(DIR_IMAGE . $this->request->post['file_file_image'])) {
			$data['file_image'] = $this->model_tool_image->resize($this->request->post['file_file_image'], 100, 100);
		} elseif ($download_info['image'] && is_file(DIR_IMAGE . $download_info['image'])) {
			$data['file_image'] = $this->model_tool_image->resize($download_info['image'], 100, 100);
		} else {
			$data['file_image'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
//end
