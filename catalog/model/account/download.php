...
class ModelAccountDownload extends Model {
	...
	public function getDownload2($download_id) {
	...
	$sql = "SELECT d.*, dd.name FROM " . DB_PREFIX . "download d INNER JOIN " . DB_PREFIX . "download_description dd ON (d.download_id = dd.download_id)";
